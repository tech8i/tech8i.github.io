...
cmnt.addEventListener("click", () => {

if (localStorage.getItem("theme") === "lit") {
function t(t) {
...
function t(t) {
    return e || (e = document.createElement("iframe"), function(e, t) {
        ...
        const t = e.dataset.host || "https://cusdis.com",
            n = e.dataset.iframe || `${t}/js/iframe.umd.js`;
        return `<!DOCTYPE html>\n<html>\n  <head>\n    <link rel="stylesheet" href="assets/css/cusdis_alt.css">\n    <base target="_parent" />\n    <link>\n    <script>\n      window.CUSDIS_LOCALE = ${JSON.stringify(window.CUSDIS_LOCALE)}\n      window.__DATA__ = ${JSON.stringify(e.dataset)}\n    <\/script>\n    <style>\n      :root {\n        color-scheme: light;\n      }\n    </style>\n  </head>\n  <body>\n    <div id="root"></div>\n    <script src="${n}" type="module">\n      \n    <\/script>\n  </body>\n</html>`
    })(t), e.style.width = "100%", e.style.border = "0", e
}
...
let swtxx = document.querySelector(".switch")

swtxx.addEventListener("click", () => {
